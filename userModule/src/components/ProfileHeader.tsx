				...
				<div className="flex-1">
					...
					<div className="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:space-x-6">
						<div className="mt-2 flex items-center text-sm text-gray-300">
							<GraduationCap className="mr-1.5 h-5 w-5 flex-shrink-0 text-purple-400" />
							{isEditing ? (
								<EditableField
						...
						<div className="mt-2 flex items-center text-sm text-gray-300">
							<MapPin className="mr-1.5 h-5 w-5 flex-shrink-0 text-purple-400" />
							{isEditing ? (
								<EditableField
						...
						<div className="mt-2 flex items-center text-sm text-gray-300">
							<Briefcase className="mr-1.5 h-5 w-5 flex-shrink-0 text-purple-400" />
							Year{" "}
							{Math.ceil(student.basicInfo.currentSemester / 2)}
						</div>
					</div>
				</div>
				<div className="flex flex-col items-end">
					<div className="inline-flex items-center rounded-full bg-green-900/40 border border-green-500/30 px-3 py-0.5 text-sm font-medium text-green-300 shadow-sm">
